...
class TheSetup:
	...
	def __init__(self, climate_chamber, sensirion_sensor, caen_1, caen_2, slots_df):
		...
		for slot_number in slots_df['Slot number']:
			self._caen_outputs_per_slot[slot_number] = OneCAENChannel(
				caen = caen_power_supplies[slots_df.loc[slot_number, 'CAEN serial number']],
	...
	def set_slot_bias_voltage(self, slot_number: int, volt: float):
...
if __name__ == '__main__':
	...
	slots_df = pandas.read_excel("/home/alf/cernbox/measurements_data/LGAD/EPR2021_LGAD_long_term_test/daemon/control/slots_definition.ods", engine="odf")
	check_integrity_of_slots_df(slots_df)
